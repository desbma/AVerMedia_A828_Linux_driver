...
*********************************************************************************/
#ifndef __OSDEP_VBUF_H__
#define __OSDEP_VBUF_H__
...
void CStrmBase_VM_Open(void *map);
void CStrmBase_VM_Close(void *map);
void *CStrmBase_VM_NoPage(void *map, unsigned long vaddr);
