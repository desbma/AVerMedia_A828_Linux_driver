...
*********************************************************************************/
#ifndef __OSDEP_V4L2_H__
#define __OSDEP_V4L2_H__
...
int CVideoDevBaseOpen(void *ObjCont, void **FileContext, void *Inode, void *File);
int CVideoDevBaseRelease(void *ObjCont, void *FileContext, void *Inode, void *File);
int CVideoDevBaseRead(void *ObjCont, void *FileContext, void *File, char *UserPtr,
                        size_t Len);
int CVideoDevBaseWrite(void *ObjCont, void *FileContext, void *File,
                        const char *UserPtr, size_t Len);

int CVideoDevBaseIOCtrl(void *ObjCont, void *FileContext, void *Inode, void *File,
                        unsigned int Cmd, void *Arg);

int CVideoDevBaseMMap(void *ObjCont, void *FileContext, void *File, VMAreaStruct *vma);


unsigned int CVideoDevBasePoll(void *ObjCont, void *FileContext, void *File, void *PollTable);
