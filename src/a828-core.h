...
*********************************************************************************/
#ifndef __A828_CORE_H__
#define __A828_CORE_H__

#define A828_DRIVER_NAME "USB Hybrid+FM Volar"
#define A828_ALSA_DRIVER_NAME "Hybrid+FM Volar"


extern int DefaultSharpness;
extern int DefaultBrightness;
extern int DefaultContrast;
extern int DefaultSaturation;
extern int DefaultHue;
