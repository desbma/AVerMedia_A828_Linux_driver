...
*********************************************************************************/
#ifndef	__KernToCUsb_HPP__
#define	__KernToCUsb_HPP__

#include	"aver/osdep.h"
#include	"aver/osdep_usb.h"
...
int UsbProbe(pUsb_interface pintf);


void UsbDisconnect(pUsb_interface pintf);

int CreateInstance(void);
void DeleteInstance(void);

int UsbModInit(pUsb_driver driver);
void UsbModExit(void);
