...
#define		DEBUG_I2C       0
#define		DEBUG_GPIO      0
#define		DEBUG_OSDEP     0
#define		DEBUG_CUSB      0
#define		DEBUG_CUSBEP    0
#define		DEBUG_CDVB      0
#define		DEBUG_CDVBFE    0 
#define		DEBUG_IA        0 
#define		DEBUG_DBGDEV    0
#define		DEBUG_CSTREAM   0
#define		DEBUG_CBUF      0
#define		DEBUG_SG        0
#define		DEBUG_VDEV      0
#define		DEBUG_CTRLPIPE  0 
#define		DEBUG_ALSA      0
#define     DEBUG_BUFFIFO   0
#include	"aver_debug.h"
